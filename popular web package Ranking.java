...
public class MostPopularWebsite {
    public static void main(String[] args) {
        ...
        List<WebPage> webPages = Arrays.asList(
                new WebPage("https://www.greenchef.com/", 8),
                new WebPage("https://www.hellofresh.ca/", 9),
                new WebPage("https://www.chefsplate.com/", 7),
                new WebPage("https://cook.homechef.com/", 8),
                new WebPage("https://www.makegoodfood.ca/", 6)
        );
